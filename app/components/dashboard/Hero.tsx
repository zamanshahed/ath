            ...
            <div className="absolute bottom-7 left-7 w-[calc(100%-60px)] z-50">
                <div className="flex items-end justify-between">
                    <div className="flex items-end space-x-1 w-max">
                        <div className="bg-white opacity-90 py-2.5 px-2 rounded-2xl flex min-w-[150px] items-center space-x-2">
                        ...
                        <div className="bg-white opacity-90 py-2.5 px-3 rounded-2xl flex min-w-[180px] items-center space-x-2">
                            <div className="flex items-center justify-center h-10 w-10">
                                <Image
                        ...
                        <div className="bg-white opacity-90 py-2.5 px-3 rounded-2xl flex w-full min-w-[190px] max-w-[200px] items-center justify-between">
                            <div>
                                <div className="text-xs font-medium">
                                    Consistency Score
                                </div>
                                <div className="text-[10px] text-[#141B34B2]/70">
                                    last 30 days
                                </div>
                            </div>
                            <ProgressSpeedometer
                        ...
                        <div className="bg-white opacity-90 py-2.5 px-3 rounded-2xl flex w-full min-w-[180px] max-w-[200px] items-center justify-between">
                            <div>
                                <div className="text-xs font-medium">
                                    Weekly Progress
                                </div>
